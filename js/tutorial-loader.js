...
function getTooltipContent(termId) {
    const tooltipContent = {
        'digital-footprint': 'The trail of data you leave behind when using the internet, including posts, likes, searches, and website visits.',
    'active-footprint': 'Information you deliberately share online, like social media posts or comments.',
    'passive-footprint': 'Data collected automatically as you use the internet, like browsing history and cookies.',
    'cookies': 'Small files websites store on your device to remember your preferences and track your activity.',
    'privacy-settings': 'Controls that let you decide who can see your online activity and personal information.',
    'geolocation': 'Information about your physical location collected by apps and devices.',
    'algorithm': 'A set of rules that determines what content you see based on your online behavior.',
    'metadata': 'Hidden information about your digital activity, like when and where a photo was taken.',
    };
...
const glossaryTerms = {
    'Digital Footprint': 'All traces of your online activity, including posts, comments, likes, shares, and browsing history.',
    'Active Digital Footprint': 'Content you intentionally create and share online, such as social media posts and comments.',
    'Passive Digital Footprint': 'Information collected about you automatically as you use the internet.',
    'Cookies': 'Small text files websites save on your device to track your preferences and behavior.',
    'Privacy Settings': 'Options that control who can see your online activity and personal information.',
    'Digital Privacy': 'Protecting your personal information and controlling what you share online.',
    'Location Services': 'Features that track and share your physical location through devices and apps.',
    'Content Filtering': 'Tools that help control what content you see and who sees your content.',
    'Digital Identity': 'Your online presence and reputation based on your digital footprint.',
    'Data Trail': 'The record of your online activities and interactions across different platforms.',
};
